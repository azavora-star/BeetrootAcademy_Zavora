...
# Write a program that counts lines and characters in a file (similar to `wc` Unix-utility, f
# or additional info about it follow the link: https://www.geeksforgeeks.org/wc-command-linux-examples/ or in case you have macOS or Linux - just call manual for this utility via command: `man wc`).
...
#     test(name) function that calls both counting functions with a given input file­name. Such a filename generally might be passed-in, hard-coded, input with raw_input, or pulled 
...
f = '/home/azavora/Projects/BeetrootAcademy_Zavora/Homework/lesson_8/task_3/myfile.txt'
